...
export default function HomeScreen() {
  ...
  const onTabPress = (tab: 'home' | 'calendar' | 'reward' | 'setting') => {
    ...
    <View style={styles.root}>
      {rewardModalVisible && (
        <View style={styles.rewardOverlay}>
          <LinearGradient
            colors={['#A7F7FF', '#7DEBEA']} // tweak to taste
            start={{ x: 0, y: 0 }}
            end={{ x: 0, y: 1 }}
      ...
      {moodPopupVisible && (
        <View style={styles.rewardOverlay}>
          ...
          >
            <Image
              source={require('../assets/images/gotit.png')} // ⬅️ adjust path/name
                    ...
                    <View key={d} style={styles.dayCell}>
                      ...
                      <Text
                        style={[
                          ...
                          // today: special colour, but still shows date number (not ✓/✗)
              ...
              >
                <View style={styles.goalTextRow}>
                  {missions.length === 0 ? (
                    ...
                    missions.map((item) => {
                      const checkboxLocked = alreadySubmitted; // simple rule: once submitted, never change
      ...
      <SafeAreaView style={styles.bottomSafeArea} edges={['bottom']}>
        <View style={styles.tabBar}>
          ...
          >
            <Ionicons name="home" size={rf(20)} color="#25D0C2" />
          ...
          >
            <Ionicons name="calendar-outline" size={rf(20)} color="#777" />
          ...
          >
            <Ionicons name="gift-outline" size={rf(20)} color="#777" />
            <Text style={styles.tabLabel}>Reward</Text>
          </TouchableOpacity>
          ...
          >
            <Ionicons name="settings-outline" size={rf(20)} color="#777" />
